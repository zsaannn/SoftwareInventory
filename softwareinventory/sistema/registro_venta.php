								...
								<form method="post" name="form_new_cliente_venta" id="form_new_cliente_venta">
									...
									<div class="row">
										...
										<div class="col-lg-4">
											<div class="form-group">
												<label>Email</label>
												<input type="email" name="email_cliente" id="email_cliente" class="form-control" disabled required>
											</div>
										</div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<p style="font-size: 16px; text-transform: uppercase; color: blue;"><?php echo $_SESSION['nombreempleado']; ?></p>
								</div>
							</div>
							<div class="col-lg-6">
								<label>Acciones</label>
								<div id="acciones_venta" class="form-group">
										<a href="#" class="btn btn-danger" id="btn_anular_venta"></i>Anular</a>
